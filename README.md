...
Trapdoor travel first moves locally to the stand tile `3095,3469,0` without Dax/web walking, then looks for the Edgeville trapdoor object: id `1579`/`1581` at tile `3097,3468,0`.
